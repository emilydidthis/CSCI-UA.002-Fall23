...
* (0.2 points) Challenge 1
* (1.3 points) Challenge 2	
* (0.5 points) Challenge 3
* (0.5 points) Challenge 4
...
* (0.25 points) Overall structure of the program is legible and organized
* (0.5 points) accurately searches items
* (1 point) list items prints a properly formatted and responsive table of items (should be adaptable to any length name of item)
* (0.5 points) accurately adds items
* (0.75 points) accurately removes items
* (1 point) accurately updates items
* (0.75 points) accurately reports items
...
* (0.25 points) listlen
* (0.25 points) listmax
* (0.25 points) listcopy
* (0.25 points) listappend
* (0.25 points) listinsert
* (0.25 points) listremove
* (0.25 points) listreverse
...
* Question 3 (4.75 points)
* Question 4 (1.75 points)